...
export default  function  Navbar() {
    ...
    return (
        <>
            <nav className='static w-full h-18 bg-black flex justify-around sm:justify-between items-center gap-10 p-3  xl:px-10 z-10'>
                <div> <img src="/logo.png" alt="EasyWheels Logo" className="h-30" /></div>
                <div className='flex gap-6 items-center text-white text-lg '>
                    ...
                    <button className="border-0 px-3 py-2 bg-red-600 text-white text-sm md:text-base rounded-2xl hover:cursor-pointer hover:scale-110 transition-transform duration-200">
                        Become a host
                    </button>
