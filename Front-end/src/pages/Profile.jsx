...
function Profile() {
  return (
    ...
    <div className="w-120 z-50">
      <div className="w-full"> <h1 className="text-3xl font-bold text-gray-700 py-5 text-center">Profile</h1></div>
        <hr className="w-full bg-gray-500"/>

      {/* Profile pic && name section */}
      <div className="w-full flex  flex-row  ">
        <img src="https://imgs.search.brave.com/IFrfkTDeXEOdpuqS16cJ_cTvFuk1-ZBdrEqFBjnL-SM/rs:fit:860:0:0:0/g:ce/aHR0cHM6Ly9weXhp/cy5ueW1hZy5jb20v/djEvaW1ncy8xYzQv/NjQ1L2NmZWJmZWE2/M2UxMDgyMWRhNzk4/ZDQzYTNhY2VhYWEy/MGYtdGhlLWJlYXIt/amVyZW15LWFsbGVu/LXdoaXRlLWxlZGUu/cnZlcnRpY2FsLnc1/NzAuanBn" 
        alt="Profile pic"
        className="w-25 h-25 rounded-full bg-amber-400 m-5"
        />
        <div className="my-6">
  
          <h2 className="text-xl  text-gray-600 font-bold">Bhuwan Kathayat</h2>
          <p className="text-md text-gray-500 font-semibold ">bhuwan214</p>

           <button className=" border border-gray-500 rounded-2xl py-1 px-2 hover:scale-105 my-2">Edit Profile</button>
        </div>
